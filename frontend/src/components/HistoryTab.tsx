  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="glass-panel p-4 rounded-xl border border-neutral-800 space-y-1 bg-neutral-950/70">
          <span className="text-[10px] uppercase font-bold text-neutral-400 tracking-wider font-mono">Total Valuations Audited</span>
          <p className="text-2xl font-bold font-mono text-white tracking-tight">{totalCount}</p>
          <p className="text-[10px] text-neutral-500 font-mono">Persisted to PostgreSQL</p>
        </div>

        <div className="glass-panel p-4 rounded-xl border border-neutral-800 space-y-1 bg-neutral-950/70">
          <span className="text-[10px] uppercase font-bold text-neutral-400 tracking-wider font-mono">Page Avg Valuation</span>
          <p className="text-2xl font-bold font-mono text-emerald-400 tracking-tight">{formatCurrency(avgValuation)}</p>
          <p className="text-[10px] text-neutral-500 font-mono">{items.length} records in view</p>
        </div>

        <div className="glass-panel p-4 rounded-xl border border-neutral-800 space-y-1 bg-neutral-950/70">
          <span className="text-[10px] uppercase font-bold text-neutral-400 tracking-wider font-mono">Page Peak Valuation</span>
          <p className="text-2xl font-bold font-mono text-white tracking-tight">{formatCurrency(maxValuation)}</p>
          <p className="text-[10px] text-neutral-500 font-mono">Highest estimated property</p>
        </div>

        <div className="glass-panel p-4 rounded-xl border border-neutral-800 space-y-1 bg-neutral-950/70">
          <span className="text-[10px] uppercase font-bold text-neutral-400 tracking-wider font-mono">Audit Database</span>
          <p className="text-2xl font-bold font-mono text-white tracking-tight">PostgreSQL 16</p>
      ...
      <div className="glass-panel p-6 sm:p-7 rounded-2xl border border-neutral-800 space-y-5 bg-neutral-950/80 shadow-2xl">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-neutral-800 pb-4">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-white border border-neutral-750 text-xs font-semibold transition-all disabled:opacity-40"
            >
            ...
            <button
              ...
              className="p-2 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-neutral-300 border border-neutral-800 text-xs transition-all"
        ...
        {loading ? (
          <div className="py-20 text-center space-y-3">
            ...
            <p className="text-xs text-neutral-400 font-mono">Querying PostgreSQL predictions table...</p>
          </div>
        ) : items.length === 0 ? (
          <div className="py-16 text-center space-y-2">
            <Database className="w-10 h-10 text-neutral-600 mx-auto" />
            <p className="text-sm font-semibold text-neutral-300">No predictions recorded yet</p>
            <p className="text-xs text-neutral-500">Run a prediction in the Valuation Studio to generate verifiable audit entries.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              <thead>
                <tr className="border-b border-neutral-800 text-[11px] text-neutral-400 uppercase font-mono bg-neutral-950">
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-neutral-900/60 transition-colors">
                      ...
                      <td className="py-3.5 px-3">
                        <span className="px-2 py-0.5 rounded bg-neutral-900 text-neutral-200 border border-neutral-700 text-[10px] font-bold">
                          {item.model_version}
                        </span>
                      </td>
                      <td className="py-3.5 px-3 text-neutral-300 font-sans text-xs">
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between border-t border-neutral-800 pt-4 font-mono text-xs">
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-neutral-900 border border-neutral-800 text-neutral-300 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-neutral-850 transition-all"
            >
